...
export function ChatInput({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 pb-6 pt-4">
      <div className="relative flex items-end gap-2 bg-white dark:bg-black/70 rounded-3xl border border-gray-200 dark:border-white/10 shadow-sm px-2 py-2">
        <button
          type="button"
          className="flex-shrink-0 h-9 w-9 rounded-full grid place-items-center text-gray-600 dark:text-white/70 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
        ...
        <textarea
          ...
          rows={1}
          className="w-full px-1 py-2 bg-transparent border-none outline-none resize-none text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-white/40 min-h-[40px] max-h-[200px] overflow-y-auto"
